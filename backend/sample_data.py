...
def create_sample_data(db: Session):
    ...
    animals = [
        models.Animal(name="Buddy", species="Dog", breed="Golden Retriever", age=3, status="available", tags="friendly,playful,good with kids",
        ...
        models.Animal(name="Max", species="Dog", breed="German Shepherd", age=4, status="available", tags="loyal,protective,intelligent",
        ...
        models.Animal(name="Bella", species="Dog", breed="Beagle", age=2, status="available", tags="curious,gentle,playful",
        ...
        models.Animal(name="Charlie", species="Dog", breed="Labrador Retriever", age=1, status="available", tags="energetic,friendly,good with kids",
        ...
        models.Animal(name="Luna", species="Dog", breed="Siberian Husky", age=3, status="available", tags="energetic,outdoor,playful",
        ...
        models.Animal(name="Rocky", species="Dog", breed="Bulldog", age=5, status="available", tags="calm,gentle,low energy",
        ...
        models.Animal(name="Daisy", species="Dog", breed="Poodle", age=2, status="pending", tags="intelligent,hypoallergenic,friendly",
        ...
        models.Animal(name="Cooper", species="Dog", breed="Border Collie", age=2, status="available", tags="intelligent,active,loyal",
        ...
        models.Animal(name="Zeus", species="Dog", breed="Rottweiler", age=4, status="available", tags="loyal,calm,protective",
        ...
        models.Animal(name="Coco", species="Dog", breed="Dachshund", age=3, status="available", tags="playful,curious,friendly",
        ...
        models.Animal(name="Whiskers", species="Cat", breed="Siamese", age=2, status="available", tags="talkative,affectionate,social",
        ...
        models.Animal(name="Oliver", species="Cat", breed="Maine Coon", age=3, status="available", tags="gentle,fluffy,calm",
        ...
        models.Animal(name="Mittens", species="Cat", breed="Persian", age=4, status="adopted", tags="calm,regal,quiet",
        ...
        models.Animal(name="Shadow", species="Cat", breed="British Shorthair", age=2, status="available", tags="independent,easygoing,calm",
        ...
        models.Animal(name="Cleo", species="Cat", breed="Abyssinian", age=1, status="available", tags="playful,athletic,curious",
        ...
        models.Animal(name="Leo", species="Cat", breed="Ragdoll", age=3, status="available", tags="docile,gentle,good with kids",
        ...
        models.Animal(name="Nala", species="Cat", breed="Bengal", age=2, status="available", tags="wild,playful,active",
        ...
        models.Animal(name="Thumper", species="Rabbit", breed="Holland Lop", age=1, status="available", tags="gentle,quiet,friendly",
        ...
        models.Animal(name="Snowball", species="Rabbit", breed="Angora", age=2, status="available", tags="calm,fluffy,quiet",
        ...
        models.Animal(name="Kiwi", species="Bird", breed="Budgerigar", age=1, status="available", tags="social,cheerful,easy care",
        ...
        models.Animal(name="Mango", species="Bird", breed="Cockatiel", age=2, status="available", tags="friendly,musical,hand-tamed",
